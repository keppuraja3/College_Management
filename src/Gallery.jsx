...
function Gallery() {
  ...
  return (
    <>
      ...
      <Container>
        <Row className=" d-flex justify-content-center align-items-center gy-5 ">
          <Col lg={3} md={4} sm={6} xs={12} style={{ maxHeight: "210px" }}>
            <Card
              style={{ width: "100%" }}
          ...
          <Col lg={3} md={4} sm={6} xs={12} style={{ maxHeight: "210px" }}>
            <Card
              ...
              className="rounded-3 overflow-hidden  border border-2 border-black h-100"
            >
              <Card.Img variant="top" src="img/college_library2.jpg" />
              <Card.Body className=" p-1">
                <Card.Title>
                  <h3 className=" text-center ">Card Title</h3>
                </Card.Title>
